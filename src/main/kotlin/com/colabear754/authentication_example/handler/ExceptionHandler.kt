...
class ExceptionHandler {
    ...
    fun handleIllegalArgumentException(e: Exception) = ResponseEntity.badRequest().body(ApiResponse.error(e.message))
    ...
    fun handleException() = ResponseEntity.internalServerError().body(ApiResponse.error("서버에 문제가 발생했습니다."))
}